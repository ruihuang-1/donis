...
params = {
    ...
    "fixed_grid": False,
    "grid_size": 100,  # 50  determines grid size of isc
    "interp_type": "cubic",  # options: cubic, idw, wind, krig
    "isc_eval_num": 500,  # 200 seed num. actual num may change after random sampling
    "do_end_isc": False,
...
def main():
    ...
    # Function Space
    func_space = dde.data.GRF(length_scale=0.5)
...
def pde(x, y, aux=None):
    ...
    return dy_t + y * dy_x - params['nu'] * dy_xx
...
def get_losses(net, func_vals, col_pts, weights, target_ic, reweighting, is_test=False):
    funcs_batch = params['num_test_func'] if is_test else params['funcs_batch']
